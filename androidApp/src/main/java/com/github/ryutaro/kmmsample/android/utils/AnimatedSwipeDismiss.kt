...
package com.github.ryutaro.kmmsample.android.utils
...
fun <T> AnimatedSwipeDismiss(
    ...
    item: T,
    background: @Composable (dismissValue: DismissValue) -> Unit,
    content: @Composable (dismissValue: DismissValue) -> Unit,
